...
| `${var.billing_admin.group.display_name}` | ${join("\n", formatlist("- %s", var.billing_admin_members[*].email))} | Manage financial aspects of cloud usage and allocate costs to various teams or projects. | `${var.billing_admin.group.object_id}` |
| `${var.billing_reader.group.display_name}` | ${join("\n", formatlist("- %s", var.billing_reader_members[*].email))} | Can read Manage financial aspects of cloud usage and allocate costs to various teams or projects. | `${var.billing_reader.group.object_id}` |
