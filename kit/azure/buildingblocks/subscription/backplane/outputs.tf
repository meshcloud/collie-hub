output "role_definition_id" {
  ...
  description = "The ID of the role definition that enables deployment of the Subscription building block to subscriptions."
}

output "role_definition_name" {
  value       = azurerm_role_definition.buildingblock_deploy.name
  description = "The name of the role definition that enables deployment of the Subscription building block to subscriptions."
}

output "role_assignment_ids" {
  value       = { for id in var.principal_ids : id => azurerm_role_assignment.buildingblock_deploy[id].id }
