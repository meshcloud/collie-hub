...
The landing zone construction kit contains a markdown-based documentation workflow. To make use of it, add a
`output "documentation_md"` to your kit module. The `documentation.tf` file generated by collie already includes
a template for this.
